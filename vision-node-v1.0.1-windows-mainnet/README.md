...
Vision is a Rust blockchain node that combines consensus, P2P networking, HTTP APIs, and a comprehensive web UI for operating the Vision mainnet. This repository ships the full node (mining + guardian) under the Apache 2.0 license.

## Features
- **Command Center** - Real-time dashboard for monitoring node status, mining, wallet, and Guardian activity
...
- VisionX PoW mining with optimized performance
- Built-in web wallet with market and exchange functionality
...
## Quick Access
After starting the node, access these interfaces:
- **Command Center**: http://localhost:7070/app (create/import wallet, then navigate to Command Center)
- **Web Wallet**: http://localhost:7070/app
- **Mining Panel**: http://localhost:7070/panel.html
- **API Documentation**: http://localhost:7070/api/
