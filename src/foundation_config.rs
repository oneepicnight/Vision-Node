...
pub static FOUNDATION_CONFIG: Lazy<Result<TokenAccountsCfg>> = Lazy::new(|| {
    ...
    let mut cfg = crate::accounts::load_token_accounts(&path).or_else(|e| {
        ...
        Ok::<TokenAccountsCfg, anyhow::Error>(TokenAccountsCfg {
            ...
            founder1_pct: 50,
            founder2_pct: 50,
            miners_btc_address: Some("bc1qyj3rh42pa22p3lth6u5529uw4r8uvecauyavc5".to_string()),
            miners_bch_address: Some("qr48t30n2gpzfwfgtqr6wrrysyc6s27g4u8h8up6l".to_string()),
            miners_doge_address: Some("DHSe6buCnpJgSJc4DFrkuJnTESBVZgpEPC".to_string()),
            founder1_btc_address: Some("bc1q3swmre3zk3jepfv36mus2s05tc8vaw2gy4w9k7".to_string()),
            founder1_bch_address: Some("qe75x4s8ral8jaqgqewrg4avqll58kxgc5eal9u5t".to_string()),
            founder1_doge_address: Some("DRsWAUD1PkU5pTCxwybngAC6tUkYfBF9Mr".to_string()),
            founder2_btc_address: Some("bc1q07wj9x8dgrcqjajg6t54hw8aswghlyex7a409a".to_string()),
            founder2_bch_address: Some("qkytj6m58n0pd4dl70qalrwqkssmcwcv0w3kts40g".to_string()),
            founder2_doge_address: Some("DFdLJanBYpC1JAw7NW6zpxJua2qNT5hJtA".to_string()),
        })
    })?;
